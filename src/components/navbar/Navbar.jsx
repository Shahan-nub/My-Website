  ...
  return (
    ...
    >
      ...
      <div className="WORK_INFO backdrop-blur-lg border-gray-500 border px-2 py-2 flex text- rounded-[3rem] items-center text-sm gap-6 lg:gap-10 text-white relative">
        <p
          className={`absolute rotate-90 leading-4 -top-2 font-extrabold text-lg bg-transparent
           ${
             usePathname() === "/" &&
             "left-[22%] shadow-[30px_5px_300px_60px_white]  md:shadow-[30px_5px_300px_30px_white]"
           } 
          ${
            usePathname() === "/info" &&
            "right-[21%] shadow-[30px_5px_300px_60px_white] md:shadow-[30px_50px_300px_30px_white] "
          }`}
        >
          |
        </p>
      ...
      <div className="inline-block lg:hidden">
        <PiLinkSimple
          className={`text-[#e3e3db] ease-in-out transition-transform duration-500 text-3xl ${showAllLinks && "rotate-[720deg]"}`}
        ...
        <motion.div
          ...
          className={`${
            showAllLinks ? "flex" : "hidden"
          } absolute flex-col backdrop-blur-sm py-2 px-3 border-[#dbdacf] border rounded-2xl top-16 right-2 z-50 text-white divide-y divide-[#dbdacf]`}
        >
          <Link
            ...
            className="flex z-20  mx-2 py-1 items-center gap-1 justify-between"
          >
            <p>LinkedIn</p>
          ...
          <Link
            ...
            className="flex z-20 mx-2 py-1 items-center justify-between"
          >
            <p>GitHub</p>
            <MdArrowOutward></MdArrowOutward>
          </Link>
